...
import { MoleculeInputPortal } from "@/components/molecule-input-portal"
import { SAMPLE_CHALLENGES } from "@/lib/challenge-data"
import { Github, FileText, ExternalLink, Shield, Wallet, Bot, PencilLine } from "lucide-react"
...
export default function Home() {
  return (
    <div className="min-h-screen orbital-bg grid-pattern">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="fade-in-up">
              ...
              <p className="mb-3 font-mono text-xs tracking-[0.2em] text-primary">
                VERIFIABLE COMPUTE FOR MOLECULES
              </p>
              <p className="mb-5 text-balance text-3xl font-medium leading-tight text-foreground md:text-4xl">
                Draw a molecule. An agent computes it. Your wallet settles it.
              </p>

              <p className="mb-8 max-w-xl text-pretty leading-relaxed text-muted-foreground">
                Submit a small molecular structure by drawing it or uploading a picture. Autonomous agents quote the work, run DFT, and return a signed result you can verify or challenge.
              </p>

              <div className="flex flex-wrap gap-4">
                <Button size="lg" className="gap-2" asChild>
                  <a href="#submit-molecule">
      ...
      <section id="submit-molecule" className="border-t border-border px-4 py-20 md:px-8 lg:px-16">
        <div className="mx-auto max-w-6xl">
          <div className="mb-10 flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
            <div className="max-w-2xl">
              <p className="mb-3 font-mono text-xs tracking-[0.2em] text-primary">SUBMISSION TERMINAL</p>
              <h2 className="text-balance text-3xl font-bold text-foreground md:text-4xl">Chemistry should start with a structure, not a string.</h2>
            </div>
            <p className="max-w-sm text-pretty text-sm leading-relaxed text-muted-foreground">
              Draw directly or upload a picture. We extract the structure, validate the molecule, then show the calculation and price before your wallet approves anything.
            </p>
          </div>
          <MoleculeInputPortal />
        </div>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 gap-6">
            ...
            <MoleculeFamilyCard
              ...
              description="ALD precursors, CVD chemistry."
            />
            <MoleculeFamilyCard
              title="Your Molecules"
              description="Draw or upload small molecules up to 50 atoms. Review the detected structure, calculation preset, and quote before paying."
              isCustom
            />
          </div>
        </div>
